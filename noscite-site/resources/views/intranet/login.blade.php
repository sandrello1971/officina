...
<head>
    <meta charset="UTF-8">
    <title>Intranet Noscite — Accesso</title>
...
<body style="background:#1A1F1F; min-height:100vh; display:flex; align-items:center; justify-content:center;">
    <div style="background:#252B2B; border-radius:16px; padding:48px 40px; width:100%; max-width:420px; border:1px solid rgba(85,177,174,0.2); text-align:center;">
        ...
        <div style="color:#55B1AE; font-weight:700; font-size:1.1rem; margin-bottom:4px;">Intranet Noscite</div>
        <div style="color:#8A9696; font-size:0.8rem; margin-bottom:32px; font-style:italic;">Area riservata al team</div>
        ...
        <a href="/intranet/auth/redirect"
           style="display:flex; align-items:center; justify-content:center; gap:12px; width:100%; padding:14px; background:white; color:#1A1F1F; border-radius:10px; font-weight:700; text-decoration:none; font-size:0.95rem; transition:opacity 0.2s;"
        ...
        <div style="margin-top:16px; color:#4A5252; font-size:0.75rem;">
            Accesso riservato agli account @noscite.it
        </div>
