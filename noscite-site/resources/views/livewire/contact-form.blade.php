<div>
    @if($sent)
        <div class="bg-green-50 border border-green-200 rounded-xl p-6 text-center">
            ...
            <h3 class="text-lg font-semibold text-green-800">Messaggio inviato!</h3>
            <p class="mt-1 text-sm text-green-600">Ti risponderemo il prima possibile.</p>
        </div>
    @else
        <form wire:submit.prevent="submit" class="bg-white rounded-2xl shadow-lg p-6 sm:p-8 space-y-6">
            ...
            <div>
                ...
                <textarea wire:model="message" id="message" rows="5"
                          ...
                          placeholder="Raccontaci il tuo progetto o la tua esigenza..."></textarea>
            ...
            <div>
                <label class="flex items-start gap-3 cursor-pointer">
                    ...
                    <span class="text-sm text-gray-600">
                        Ho letto e accetto la <a href="{{ route('privacy') }}" target="_blank" class="text-primary-600 underline hover:text-primary-700">Privacy Policy</a> *
                    </span>
                </label>
            ...
            <button type="submit"
                    ...
                    class="w-full px-6 py-3 text-base font-semibold text-white bg-primary-600 rounded-lg hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-lg shadow-primary-600/25">
