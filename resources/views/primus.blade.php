...
@section('description', 'RUMORE DI FONDO — Il punto zero del percorso Effetto Glitch. 4 ore per imprenditori e dirigenti PMI. Mappa di Maturita Digitale personalizzata. Propedeutico a INTERFERENZA e SEGNALE.')
...
<section style="background:linear-gradient(135deg,#1A1F1F 0%,#3A8C89 100%);position:relative;overflow:hidden;color:white" class="py-20 px-4">
    ...
    <div class="max-w-4xl mx-auto" style="position:relative;z-index:1">
        ...
        <p class="text-base max-w-2xl" style="color:rgba(255,255,255,0.9)">Il punto zero del percorso Effetto Glitch. Per imprenditori e dirigenti che vogliono capire se e perche l'AI riguarda davvero la loro PMI — prima di investire tempo, energia e denaro in formazione.</p>
    </div>
</section>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="space-y-4">
            @foreach([
                ...
                "Ricevere la Mappa di Maturita Digitale personalizzata + percorso Effetto Glitch consigliato",
            ] as $obj)
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="space-y-5">
            ...
            <div class="corso-card">
                ...
                <p style="color:#4A5252">Consegna della Mappa di Maturita Digitale personalizzata. Presentazione del percorso Effetto Glitch consigliato: INTERFERENZA (strategia), SEGNALE (operativita) o entrambi.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-12 px-4">
    <div class="max-w-3xl mx-auto p-6 rounded-xl" style="background:linear-gradient(135deg,#E8F5F5,#55B1AE);color:white">
        ...
        <div class="flex flex-col gap-2 text-base font-semibold">
            ...
            <div class="flex items-center gap-2">&#10003; Percorso Effetto Glitch consigliato (INTERFERENZA, SEGNALE o entrambi)</div>
            <div class="flex items-center gap-2">&#10003; Attestato di partecipazione Effetto Glitch</div>
        </div>
    </div>
</section>
