            ...
            <div style="margin-bottom:20px; padding:14px 16px; background:rgba(226,138,83,0.15);
                ...
                <div style="background:rgba(0,0,0,0.2); border-radius:8px; padding:10px 14px;
                    ...
                    <div style="color:#E8EDED; margin-bottom:4px;">
                        📧 <span style="color:#55B1AE;">{{ atheneum_setting('demo_user_email', 'demo@effettoglitch.it') }}</span>
                    </div>
                ...
                <button onclick="
                    document.querySelector('input[name=email]').value='{{ atheneum_setting('demo_user_email', 'demo@effettoglitch.it') }}';
