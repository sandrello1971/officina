...
<div style="max-width:900px; margin:20px auto 0;">
    <div style="background:white; border-radius:12px; padding:24px;"
        ...
        <p style="font-size:0.78rem; color:#8A9696; margin-bottom:12px;">Slide 16:9 brandizzate (tema GLITCH). I corsisti vedono solo la versione pubblicata.</p>
        ...
        <div style="background:white; border-radius:12px; padding:24px;"
            ...
            @if(($modVideo?->status ?? null) === 'ready' && $modVideo->file_path)
                <div style="margin-top:14px; border-top:1px solid #F0F2F2; padding-top:12px; display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
                    ...
                    <a href="{{ route('admin.courses.modules.video.download', [$course, $module]) }}" style="padding:7px 13px; background:white; color:#3A8C89; border:1px solid #3A8C89; border-radius:8px; font-size:0.8rem; font-weight:600; text-decoration:none;">&#11015; Scarica video (.mp4)</a>
                </div>
            @endif
