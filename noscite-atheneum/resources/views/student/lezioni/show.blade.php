...
<div style="max-width:900px;" x-data="lessonPage()">
    ...
    <div style="display:flex; gap:16px; margin-top:16px; align-items:flex-start;">
        <div style="flex:1; background:white; border:1px solid #C8D0D0; border-radius:10px; padding:20px 22px;">
            <div class="md-body lesson-body" style="font-size:0.95rem; line-height:1.7; color:#1A1F1F;">{!! $bodyHtml !!}</div>
        </div>
    </div>
