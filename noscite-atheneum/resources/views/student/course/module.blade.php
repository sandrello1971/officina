...
<div style="display:grid; grid-template-columns:1fr 280px; gap:24px; max-width:1100px;">
    ...
    <div>
        ...
        <div style="background:white; border-radius:12px; overflow:hidden; margin-bottom:20px;"
             x-data="videoPlayer('{{ $module->video_ai_id }}')" x-init="init()">

            <div style="position:relative; background:#000; border-radius:12px 12px 0 0;">
                <video id="video-player"
                       style="width:100%; max-height:400px; display:block;"
                       controls
                       preload="metadata">
                    <source src="/learn/video/{{ $module->video_ai_id }}/stream" type="video/mp4">
                </video>
            ...
            <div x-show="activeTab==='chat'" style="padding:16px;">
                <div id="video-chat-messages" style="max-height:200px; overflow-y:auto; margin-bottom:12px; display:flex; flex-direction:column; gap:8px;">
